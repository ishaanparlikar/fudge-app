...
useEffect(() => {
   ...
   return (
      <>
         <div className="xl:flex h-screen main-bg-img">


            <Sidebar />

            <div className='xl:py-6 pt-20 w-full z-20'>
               <div className={`fixed bg-white  dashboard h-full overflow-scroll ${active ? 'active' : ''}`}>


                  <TopBar user='John Doe' />

                  <div className="row flex   items-center mx-4 my-8">
